...
def main():
    ...
    logger = prepare_directories_and_logger("/content/drive/MyDrive/Colab Notebooks/VoiceClone/full_wt2_model/model_outputs/ljspeech_lsa_smooth_attention", "logdir")
